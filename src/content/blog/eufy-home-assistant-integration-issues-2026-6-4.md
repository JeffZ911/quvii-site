...
It is important to distinguish between a "breaking change" in the [Home Assistant](https://quvii.com/blog/home-assistant-2026-7-0b0-camera-breaking-changes) Core itself and an external failure of a custom integration. [Home Assistant Core](https://quvii.com/learn/fix-eufy-security-home-assistant-2026-6-4) 2026.6.4 was largely a maintenance release focused on streamlining the Matter protocol and enhancing energy dashboard visualizations. However, its release coincided with a backend update to Eufy’s own cloud infrastructure. 
...
| **TP-[Link Tapo](https://quvii.com/blog/tp-link-tapo-camera-integration-not-working)** | C425 / C325WB | Wi-Fi | Yes (Official) | No |
