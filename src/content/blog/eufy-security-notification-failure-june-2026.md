...
In the first week of June 2026, Eufy Security began rolling out a series of updates intended to refine its BionicMind AI and enhance data privacy. However, the deployment resulted in a cascading failure of [push notifications](https://quvii.com/blog/eufy-motion-push-notifications-failing-july-2026), primarily for users utilizing the HomeBase 3 (S380) central hub. Reports from community hubs like <a href="https://www.amazon.com/s?k=r%2FEufyCam&tag=jeffzen911-20" rel="sponsored nofollow noopener" target="_blank">r/EufyCam</a> and official support tickets indicated that while cameras were still recording events to local storage, the critical "handshake" between the local hub and the user’s smartphone was failing.
