...
*   **Limitation:** Battery-powered cameras connected to HomeBase 3 generally do not support continuous RTSP to preserve battery life, though some "NAS" storage options exist in the settings menu for specific event-based recording.
