...
| **Using [Home Assistant](https://quvii.com/blog/home-assistant-2026-7-0b0-camera-breaking-changes)/Scrypted** | **Research.** Check the latest integration notes before updating, as new firmware often breaks API paths. |
