...
The most significant impact on the Arlo community in early 2026 was the removal of "Activity Zones" for non-subscribers. This move sparked significant backlash on r/Arlo, as users who previously relied on local storage found their cameras flooded with "nuisance alerts" from street traffic that they could no longer filter out via the app. For existing Pro 4 or [Pro 5S](https://quvii.com/learn/arlo-pro-5s-2k-night-vision-stuck-on) owners, upgrading to the Pro 6 provides better battery and USB-C convenience, but it does not escape the new subscription reality.
