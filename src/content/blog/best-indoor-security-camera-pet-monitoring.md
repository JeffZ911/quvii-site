...
Simultaneously, Eufy released firmware version 3.3.2.6+ for the Indoor Cam S350. This update introduced the "Pet Diary" feature, which utilizes the dual-lens system to create automated daily highlight reels. By leveraging the HomeBase 3’s local processing power, the system identifies "key moments"—like a dog playing with a specific toy—and stitches them into a 60-second summary stored entirely on local hard drives. This move directly addresses the "subscription fatigue" reported by users who previously paid for similar features via Nest Aware or Ring Protect.
