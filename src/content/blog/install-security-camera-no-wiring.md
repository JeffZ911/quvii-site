...
**Network foundation:** High-resolution 4K or 2K cameras demand significant bandwidth. A [Wi-Fi 6 (802.11ax)](https://en.wikipedia.org/wiki/Wi-Fi_6) router is recommended to handle the high-bitrate streams without causing congestion for your other devices. Wi-Fi 6 also supports Target Wake Time (TWT), a feature that allows cameras to stay in a low-power sleep state longer, extending battery life.
