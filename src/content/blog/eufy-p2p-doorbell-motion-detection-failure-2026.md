...
2.  **Toggle [Motion Detection](https://quvii.com/blog/arlo-ultra-motion-detection-not-working-fix):** Go into the doorbell settings and toggle the "Motion Detection" switch to OFF. Wait approximately 30 seconds, then toggle it back ON. This forces a reset of the Passive Infrared (PIR) sensor's state and can clear "stuck" detection logic.
