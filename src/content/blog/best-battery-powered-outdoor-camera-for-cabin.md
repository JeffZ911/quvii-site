...
The SoloCam S340 is ideal for users who want a "set it and forget it" installation. The dual-lens system provides both a wide-angle view of the cabin grounds and a zoomed-in telephoto view of the main entry point. Because the solar panel is built into the top of the unit (though it can be adjusted), the installation is extremely clean. When paired with a HomeBase 3, it offers some of the most advanced AI detection on the market, including the ability to recognize specific family members and ignore them in your alert feed.
