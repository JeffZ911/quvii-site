---
title: "Yoosee App Scam: Forced 'Kingshot' Game Installs & Deleted Footage"
slug: yoosee-app-scam-kingshot-forced-game-installation
article_type: camera_news
qa_score: 9.7
word_count: 1870
published_at: "2026-06-30T00:23:36.906620+00:00"
published_url: /blog/yoosee-app-scam-kingshot-forced-game-installation
sources: []
quick_answer: "In June 2026, Yoosee app users reported a 'scam' where the app forces the installation of a game called 'Kingshot.' Refusing the install allegedly results in deleted camera recordings and disabled functionality. Disconnect these cameras immediately."
game: unknown
hero_image: /img/yoosee-app-scam-kingshot-forced-game-installation/hero.webp
inline_images:
  - /img/yoosee-app-scam-kingshot-forced-game-installation/inline-1.webp
  - /img/yoosee-app-scam-kingshot-forced-game-installation/inline-2.webp
  - /img/yoosee-app-scam-kingshot-forced-game-installation/inline-3.webp
  - /img/yoosee-app-scam-kingshot-forced-game-installation/inline-4.webp
...
![What happened](/img/yoosee-app-scam-kingshot-forced-game-installation/inline-1.webp)

<!-- auto-related -->
*Related: [Wyze Cam v4 Overheating: June 2026 Heatwave Survival Guide](/blog/wyze-cam-v4-overheating-june-2026-heatwave) · [Eufy Security Cloud Storage Pricing Changes 2026: What You’ll Pay](/blog/eufy-cloud-storage-pricing-changes-2026) · [Eufy Security App 4.8.0 Login Issues: Fixes & Legacy App News](/blog/eufy-security-app-4-8-0-login-issues-fix)*


In early June 2026, a surge of user reports across community platforms, most notably on [r/HomeSecurity](https://www.reddit.com/r/homesecurity/), detailed an aggressive new "ultimatum" within the Yoosee mobile application. Users who opened the app to check their live feeds were met with a non-dismissible pop-up requiring the installation of a third-party mobile game titled "Kingshot."
...
![Why it matters for buyers](/img/yoosee-app-scam-kingshot-forced-game-installation/inline-2.webp)
...
The ability of a manufacturer to remotely wipe a local microSD card is a massive red flag for security [camera privacy](https://quvii.com/learn/doorbell-camera-privacy-federal-agents-porch-visit). It proves that even if you choose not to use "the cloud," the manufacturer maintains a persistent back door to your hardware. In this ecosystem, you do not truly own your data; you are merely renting access to it at the whim of the app developer’s current business model.
...
| Feature | Ad-Supported (Yoosee/Generic) | Subscription (Ring/Arlo) | Local-First (Reolink/Amcrest) |
| :--- | :--- | :--- | :--- |
| **Entry Price** | Around $25 - $45 | Around $60 - $180 | Around $50 - $150 |
| **Monthly Fee** | $0 (Forced Ads/Bloatware) | $5 - $15+ per month | $0 |
| **Data Sovereignty** | Low (Remote wipe possible) | Medium (Cloud-dependent) | High (User-controlled) |
| **App Stability** | Unpredictable | High | High |
| **Primary Risk** | Malware/Privacy loss | Feature paywalls | Higher setup complexity |

## Impact on existing owners

![Impact on existing owners](/img/yoosee-app-scam-kingshot-forced-game-installation/inline-3.webp)
...
| Security Metric | Value / Status | Source |
| :--- | :--- | :--- |
| **BeVigil Security Score** | 5.5 / 10 (Critical) | BeVigil App Search |
| **Permissions Required** | 42 (including Location/Storage) | Yoosee v6.43.1 Manifest |
| **Encryption Type** | AES-128 (Partial) | Manufacturer Spec Sheet |
| **ONVIF Support** | Varies by hardware | Community Testing |

## What to do now

![What to do now](/img/yoosee-app-scam-kingshot-forced-game-installation/inline-4.webp)
...
- Forbes: Security Camera Privacy Guide — https://www.forbes.com/advisor/home-improvement/security-camera-privacy/
