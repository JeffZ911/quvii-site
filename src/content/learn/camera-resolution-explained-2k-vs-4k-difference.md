...
qa_score: 8.3
word_count: 2149
published_at: "2026-05-29T00:22:12.655139+00:00"
published_url: /learn/camera-resolution-explained-2k-vs-4k-difference
sources: []
...
# Camera Resolution Explained: 2K vs. 4K Security Cameras
...
| Resolution | Common Name | Pixel Dimensions | Total Pixels | Aspect Ratio |
| :--- | :--- | :--- | :--- | :--- |
| 1080p | Full HD / 2MP | 1920 x 1080 | ~2.1 Million | 16:9 |
| 2K | 1440p / 4MP | 2560 x 1440 | ~3.7 Million | 16:9 |
| 4K | 2160p / 8MP | 3840 x 2160 | ~8.3 Million | 16:9 |
...
Video is a stream of data measured in bits per second (bitrate). A 4K stream typically requires between [6 Mbps and 12 Mbps](https://reolink.com/blog/security-camera-bandwidth-calculation/) to maintain high quality. Without efficient compression, this would quickly clog a home network and fill up storage drives.
...
| Resolution | Bitrate (H.265) | GB per 24 Hours | Days on 256GB Card |
| :--- | :--- | :--- | :--- |
| 2K (4MP) | 4 Mbps | ~43 GB | ~5.9 Days |
| 4K (8MP) | 8 Mbps | ~86 GB | ~2.9 Days |

*Note: These values are estimates based on [continuous recording at 15 FPS](https://reolink.com/blog/security-camera-bandwidth-calculation/). Using motion-only recording can extend these durations to weeks or months.*

### Network Impact: Is Your Wi-Fi Ready?

If you plan to install multiple 4K Wi-Fi cameras, your network needs to be up to the task. An older Wi-Fi 5 (802.11ac) router may struggle with the sustained [6–12 Mbps upload](https://reolink.com/blog/security-camera-bandwidth-calculation/) required by each 4K camera, especially if they are far from the router. For a 2026 setup, Wi-Fi 6 or Wi-Fi 7 is highly recommended to handle the increased "airtime" required for high-resolution streams without causing lag in other household devices.
...
![Common misconceptions](/img/camera-resolution-explained-2k-vs-4k-difference/inline-5.webp)
...
In security, [15 Frames Per Second (FPS)](https://reolink.com/blog/security-camera-bandwidth-calculation/) is often the "sweet spot." While 30 or 60 FPS looks smoother (like a movie), it doubles or triples the storage requirements. For most security applications, 15 FPS is more than enough to capture a license plate or a face without consuming excessive bandwidth. High-resolution 4K cameras often default to 15 or 20 FPS to balance detail with performance.
...
- B&H Photo Video — https://www.bhphotovideo.com/explora/video/tips-and-solutions/understanding-resolution-and-aspect-ratio
- Digital Trends (2K) — https://www.digitaltrends.com/computing/what-is-2k-resolution/
- Digital Trends (4K) — https://www.digitaltrends.com/home-theater/what-is-4k-resolution/
- Axis Communications (DORI Standard) — https://www.axis.com/learning/technical-guide-to-network-video/dori-standard
- Reolink (Bandwidth Calculation) — https://reolink.com/blog/security-camera-bandwidth-calculation/
- Security.org (H.265 vs H.264) — https://www.security.org/security-cameras/h265-vs-h264/
- Hikvision (DarkFighter Technology) — https://www.hikvision.com/en/core-technologies/low-light-imaging/darkfighter/
- Axis Communications (WDR) — https://www.axis.com/learning/technical-guide-to-network-video/wide-dynamic-range