...
*   **Wyze Cam v3:** Received official beta RTSP firmware; later removed from official sites; still used via community archives.
*   **Wyze Cam v3 Pro:** Never received official RTSP firmware; requires third-party bridges.
