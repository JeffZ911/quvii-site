...
A sync error between a [eufyCam S330](https://quvii.com/blog/eufycam-s330-firmware-3-1-8-2-motion-detection-failure) and its HomeBase 3 effectively blinds a high-end [4K security](https://quvii.com/learn/best-4k-security-cameras-local-storage) system, usually due to a stalled firmware handshake that prevents the camera from communicating with the hub.
...
| **[Arlo Pro 5S](https://quvii.com/learn/arlo-pro-5s-2k-night-vision-stuck-on)** | ~$350 - $400 | ~$360 ($10/mo) | Included | **~$710** |
