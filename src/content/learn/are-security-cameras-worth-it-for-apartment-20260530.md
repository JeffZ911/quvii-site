...
*   **Edge AI:** On-device chips (like Eufy’s BionicMind) process the video locally. Instead of sending raw footage to the cloud to check if a "person" is present, the camera does the math itself.
