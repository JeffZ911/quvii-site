...
This is a frequent complaint on the <a href="https://www.amazon.com/s?k=Wyze+Forums&tag=jeffzen911-20" rel="sponsored nofollow noopener" target="_blank">Wyze Forums</a>. While Wyze has moved many features (like AI Person Detection) behind a paywall, **local microSD recording remains a free feature.** The confusion arises because the "Events" tab is heavily geared toward cloud clips. To view your free SD footage, you must often tap "Live Stream" -> "More" -> "Playback," a path that Wyze has made less intuitive in the 3.x app.
