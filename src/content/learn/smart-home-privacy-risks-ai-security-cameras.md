...
Yes, even [cameras with local](https://quvii.com/learn/best-4k-security-cameras-local-storage) storage can pose [privacy risks](https://quvii.com/blog/privacy-risks-ai-surveillance-cameras-2026). While video footage might stay on an SD card or NVR, many cameras still send metadata (e.g., "person detected," timestamps) and telemetry data to the cloud for app functionality, firmware updates, or analytics.
